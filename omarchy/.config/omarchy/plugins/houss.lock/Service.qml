...
Item {
  ...
  // Keep the display lit for the whole lock. The stock plugin blanks the panel
  // five seconds in; leaving the timer unarmed is enough, since nothing else
  // starts it and runBlank() is only reached from its onTriggered.
